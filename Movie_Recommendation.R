...
eval_resultset <- function(ratingmat)
{
  ...
  models_to_evaluate <- list(IBCF_cos = list(name = "IBCF", param = list(method = "cosine")),UBCF_cos = list(name = "UBCF", param = list(method = "cosine")))
...
#Most Viewed movies#
most_viewed_movie <- function(ratingmat, Movie_Details)
{
  ...
  for (i in 1:9066)
  {
    table_views[i,3] <- as.character(subset(dataList$Movie_Details, dataList$Movie_Details$MovieID == table_views[i,1])$title)
  }
  return(table_views)
}
...
View(binaryratings)
ratings <- user_ratings(binaryratings)
View(ratings)
genre_matrix3 <- filter_ratings(dataList$Movie_Details,dataList$Movie_Dataset)
View(genre_matrix3)
result <- cal_dot_product(ratings,genre_matrix3)
View(result)

output <- mov_rec(result,dataList$Movie_Details)
View(output)

#UBCF#
ratingmat <- createRatingMatrix(dataList$Movie_Dataset)
recom_result <-evaluateModels(ratingmat,dataList$Movie_Details)
eval_results <- eval_resultset(ratingmat)
View(recom_result)
View(eval_results)


#Movie_Views#
#movie_views <- most_viewed_movie(ratingmat, dataList$Movie_Details)
#View(movie_views)
